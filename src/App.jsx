          ...
          <div className="content-padding">
            ...
            <div style={{marginBottom: 50}}>
               <div className="plan-card">
                  ...
                  <a href={getCheckoutLink("https://ggcheckout.app/checkout/v5/bL3st259TCQudnq6bWOi")} target="_blank" rel="noreferrer" className="btn-buy btn-white">Escolher Plano</a>
               </div>
               <div className="plan-card plan-highlight">
                  ...
                  <a href={getCheckoutLink("https://ggcheckout.app/checkout/v5/FLB3OSBKO6S0CbpJUG1T")} target="_blank" rel="noreferrer" className="btn-buy btn-green">Escolher Plano</a>
               </div>
            </div>
